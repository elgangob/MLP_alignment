...
alignment <- read.fasta("Documents/MEGA_12/Stevenson_Alignment/All_Mlp_DNA_alignedonly.fas", 
                        forceDNAtolower = FALSE)

# Read the .rec file, completely ignoring the broken headers (header = FALSE, skip = 1)
rec_table <- read.delim("Coding/3seq build 170612/3seq_results.3s.rec", 
                        header = FALSE, 
                        skip = 1,
...
# 6. Open the PDF
pdf("Documents/Stevenson Project/Mlp_Recombination_Plots.pdf", width = 10, height = 6)
