...
alignment <- read.fasta("Documents/Stevenson Project/Aligned (For 3Seq)//Normal/All Mlp DNA_aligned_only.fas", 
...
#===================================================================================
#Short Sequence (L25 t1e-5)

# 2. Load your alignment
alignment <- read.fasta("Documents/Stevenson Project/Aligned (For 3Seq)/Short/All Mlp DNA_short_aligned.fas", 
                        forceDNAtolower = FALSE)

# Read the .rec file, completely ignoring the broken headers (header = FALSE, skip = 1)
rec_table <- read.delim("Coding/3seq build 170612/3seq_prof_match.3s.rec", 
                        header = FALSE, 
                        skip = 1,
                        stringsAsFactors = FALSE)
...
# 6. Open the PDF
pdf("Documents/Stevenson Project/Mlp_Recombination_Plot_Test.pdf", width = 10, height = 6)
...
# Read the .rec file, completely ignoring the broken headers (header = FALSE, skip = 1)
rec_table <- read.delim("Coding/3seq build 170612/3seq_normal_test.3s.rec", 
                        header = FALSE, 
                        skip = 1,
                        stringsAsFactors = FALSE)
...
# 6. Open the PDF
pdf("Documents/Stevenson Project/Mlp_Recombination_Plot_Test_Normal.pdf", width = 10, height = 6)
